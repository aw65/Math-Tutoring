 ...
 * 
 */
public class U4A3FinalProject_Lesson3C extends JFrame  implements ActionListener{
    ...
    ImageIcon icon4 = new ImageIcon("Lesson3p2.png");
   
    public U4A3FinalProject_Lesson3C(){
        ...
        //Let set the text in the label
        lblDisplay3.setText("Finding the y intercept");
        //Let change the font size of the text in the label
        ...
        lblillustration.setBounds(50,90,500,350);
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Next")){
           U4A3FinalProject_Lesson3D f1 = new U4A3FinalProject_Lesson3D();
