 ...
 * 
 */
public class U4A3FinalProject_Lesson1C extends JFrame  implements ActionListener{
    ...
    ImageIcon icon4 = new ImageIcon("Lesson1p3.png");//adding images
    public U4A3FinalProject_Lesson1C(){
        ...
        //Let set the text in the label
        lblDisplay.setText("<html>Example: Convert into y-intercept form.</html>");
        ...
        lblillustration.setBounds(50,175,500,300);
