 ...
 * 
 */
public class U4A3FinalProject_Lesson2A extends JFrame  implements ActionListener{
    ...
    public U4A3FinalProject_Lesson2A(){
        ...
        lblDisplay.setLocation(25,0);
        //Let set the text in the label
        lblDisplay.setText("<html>Lines that are parallel to each other have the same slope.<br>"
                +"<br>"+"Example1: Which of the following equations are parallel to each other?<br>"
                +"<br>"+" y = 5x − 3   y = −5x + 2   y = 3x − 3   y = 5x + 2<br>"
                +"<br>"+"y =5x−3 and y =5x+2 are parallel to each other because they have the same slope of 5x.</html>");
        ...
        //Let set the text in the label
        lblDisplay3.setText("Parallel Lines");
        //Let change the font size of the text in the label
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Previous")){
           U4A3FinalProject_Lesson1D f1 = new U4A3FinalProject_Lesson1D();
           f1.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
           f1.setSize( 600, 500 ); // set frame size
           f1.setVisible( true ); // display frame
           f1.setLocationRelativeTo(null); 
