 ...
 * 
 */
public class U4A3FinalProject_Lesson2D extends JFrame  implements ActionListener{
    ...
    ImageIcon icon4 = new ImageIcon("Lesson2p2.png");
   
    public U4A3FinalProject_Lesson2D(){
        ...
        //Let set the text in the label
        lblDisplay3.setText("Illustration for The Example2");
        //Let change the font size of the text in the label
        ...
        lblillustration.setBounds(130,110,350,350);
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Previous")){
           U4A3FinalProject_Lesson2C f1 = new U4A3FinalProject_Lesson2C();
           f1.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
           f1.setSize( 600, 500 ); // set frame size
           f1.setVisible( true ); // display frame
           f1.setLocationRelativeTo(null); 
