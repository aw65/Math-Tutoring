 ...
 * 
 */
public class U4A3FinalProject_Lesson2B extends JFrame  implements ActionListener{
    ...
    ImageIcon icon4 = new ImageIcon("Lesson2p1.png");
   
    public U4A3FinalProject_Lesson2B(){
        ...
        //Let set the text in the label
        lblDisplay3.setText("Illustration for The Example1");
        //Let change the font size of the text in the label
        ...
        lblillustration.setBounds(130,100,350,350);
