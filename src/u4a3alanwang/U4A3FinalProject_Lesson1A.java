 ...
 * 
 */
public class U4A3FinalProject_Lesson1A extends JFrame  implements ActionListener{
    ...
    ImageIcon icon4 = new ImageIcon("Lesson1p1.jpg");
   
    public U4A3FinalProject_Lesson1A(){
        ...
        lblDisplay.setLocation(25, -90);
        //Let set the text in the label
        lblDisplay.setText("<html>The equation of a line has 2 basic forms. One is y-intercept form and the other is called standard form.<br>"
                +"y-intercept form takes the form y = mx + b<br>"
                +"Standard form looks like Ax +By + C=0</html>");
        ...
        //Let set the text in the label
        lblDisplay3.setText("Equation of a Line");
        //Let change the font size of the text in the label
        ...
        lblDisplay4.setLocation(25, 220);
        //Let set the text in the label
        lblDisplay4.setText("Y-intercept Form");
        //Let change the font size of the text in the label
        ...
        lblillustration.setBounds(50,265,500,125);
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Next")){
           U4A3FinalProject_Lesson1B f1 = new U4A3FinalProject_Lesson1B();
