 ...
 * 
 */
public class U4A3FinalProject_Lesson3A extends JFrame  implements ActionListener{
    ...
    public U4A3FinalProject_Lesson3A(){
        ...
        lblDisplay.setLocation(25,-25);
        //Let set the text in the label
        lblDisplay.setText("<html>The x intercept is where a line intersects or “hits” the x axis and the y intercept is where that same line intersects the y axis.<br>"
                +"<br>"+"Example Find the x and y intercepts for the equation<br>"
                +"<br>"+"3x + 2y – 5 = 0.</html>");
        ...
        lblDisplay3.setSize(600, 30);
        lblDisplay3.setLocation(25, 90);
        //Let set the text in the label
        lblDisplay3.setText("Finding the x intercept and the y intercepts");
        //Let change the font size of the text in the label
    ...
    public void actionPerformed (ActionEvent e){
       ...
       if(e.getActionCommand().equals("Next")){
           U4A3FinalProject_Lesson3B f1 = new U4A3FinalProject_Lesson3B();
       ...
       if(e.getActionCommand().equals("Previous")){
           U4A3FinalProject_Lesson2E f1 = new U4A3FinalProject_Lesson2E();
           f1.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
           f1.setSize( 600, 500 ); // set frame size
           f1.setVisible( true ); // display frame
           f1.setLocationRelativeTo(null); 
