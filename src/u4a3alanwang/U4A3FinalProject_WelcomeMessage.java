 ...
 * 
 */
public class U4A3FinalProject_WelcomeMessage extends JFrame  implements ActionListener{
    ...
    public U4A3FinalProject_WelcomeMessage(){
        super( "Welcome!" );//This will be displayed in the Title Bar
        ...
        lblWelcome.setText("Welcome to The World of Equations!");
        ...
        lblDisplay.setLocation(50, -10);
        //Let set the text in the label
        lblDisplay.setText("<html>Hi there! Welcome to the Introduction to Equations!<br>"
                +"<br>"+"This program contains three lessons base on the textbook(Course code:MPM1D).<br>"
                +"<br>"+"For each lesson there will be few practice questions attached.<br>"
                +"<br>"+" At the end of the lesson there will be a small test to show you are good to pass or you need extra practice.<br>"
                +"<br>"+" Now let's get start!(Click the arrow button below)</html>");
